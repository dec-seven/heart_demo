...
function createSprite(canvas, pos={x:0.6,y:0.1,z:0.2}) {
...
scene.add(createSprite(getCanvas("曾泽彪")))
scene.add(createSprite(getCanvas("ZB"),{x:0.2,y:0.6,z:0.5}))
scene.add(createSprite(getCanvas("周杰伦"),{x:0.7,y:0.8,z:0.4}))
